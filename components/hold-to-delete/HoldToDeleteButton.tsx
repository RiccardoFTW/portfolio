...
export function HoldToDeleteButton() {
  return (
    <button
      ...
      className="hold-to-delete-btn rounded-full outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-(--component-surface)"
    >
      <ButtonContent
